...
def process_episode(dataset, episode_path, states_name, actions_name):
    ...
    for i in range(num_frames):
        frame = {
            "state": np.hstack([kinematics_data[n][i] for n in states_name]),
        ...
        for cam_name, images in [
            ...
            if images.size > 0:
                # Resize the image to 224x224 before adding to the frame
                resized_img = np.array(Image.fromarray(images[i]).resize((224, 224)))
...
def process_all_suturing_episodes(base_dir: str, repo_id: str):
    ...
    # states_name = [
    #     "psm1_pose.position",
    #     "psm1_pose.orientation",
    #     "psm1_jaw",
    #     "psm2_pose.position",
    #     "psm2_pose.orientation",
    #     "psm2_jaw",
    # ]
    # actions_name = [
    #     "psm1_sp.position",
...
if __name__ == "__main__":
    suturing_base_dir = "/home/iulian/chole_ws/data/Jesse/"  # Suturing data directory
