...
if __name__ == "__main__":
    ...
    chole_base_dir = "/cis/home/sschmi46/chole_ws/data/base_chole_clipping_cutting"  # Name of the output dataset, also used for the Hugging Face Hub
    suturing_base_dir = "/cis/home/sschmi46/chole_ws/data/Jesse"  # Name of the output dataset, also used for the Hugging Face Hub
    repo_id = "chole_suturing_lerobot"  # Name of the output dataset, also used for the Hugging Face Hub
